      ...
      >
          ...
          {isExpanded && (
            ...
            >
              ...
              >
                ...
                >
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" className="fill-foreground" />
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          ...
          <div className="flex items-start justify-between">
            ...
            {/* Status indicator */}
            <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-foreground/5 backdrop-blur-sm">
          ...
          <div className="space-y-1">
            ...
            {/* Animated underline */}
            <motion.div
              className="h-px bg-gradient-to-r from-foreground/50 via-foreground/30 to-transparent"
              initial={{ scaleX: 0, originX: 0 }}
              animate={{
                scaleX: isExpanded ? 1 : 0.3,
              }}
