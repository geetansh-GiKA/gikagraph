...
const defaultMarkers: CdnMarker[] = [
  { id: "rfp-was", location: [38.95, -77.45], region: "Federal (US)" },
  { id: "rfp-sfo", location: [37.62, -122.38], region: "State & Local" },
  { id: "rfp-cdg", location: [49.01, 2.55], region: "EU Tenders" },
  { id: "rfp-hnd", location: [35.55, 139.78], region: "APAC Public" },
  { id: "rfp-syd", location: [-33.95, 151.18], region: "ANZ Gov" },
  { id: "rfp-gru", location: [-23.43, -46.47], region: "LATAM" },
  { id: "rfp-sin", location: [1.36, 103.99], region: "SEA Enterprise" },
  { id: "rfp-arn", location: [59.65, 17.93], region: "Nordics" },
  { id: "rfp-dub", location: [53.43, -6.25], region: "UK & Ireland" },
  { id: "rfp-bom", location: [19.09, 72.87], region: "India" },
]

const defaultArcs: CdnArc[] = [
  { id: "rfp-arc-1", from: [38.95, -77.45], to: [49.01, 2.55] },
  { id: "rfp-arc-2", from: [37.62, -122.38], to: [35.55, 139.78] },
  { id: "rfp-arc-3", from: [49.01, 2.55], to: [1.36, 103.99] },
  { id: "rfp-arc-4", from: [38.95, -77.45], to: [-23.43, -46.47] },
  { id: "rfp-arc-5", from: [35.55, 139.78], to: [-33.95, 151.18] },
  { id: "rfp-arc-6", from: [49.01, 2.55], to: [19.09, 72.87] },
]
...
export function GlobeCdn({
  ...
  const [traffic, setTraffic] = useState(() =>
    defaultArcs.map((a, i) => ({ id: a.id, value: [42, 38, 29, 18, 15, 13][i] || 10 }))
  )
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setTraffic((data) =>
        data.map((t) => ({
          ...t,
          value: Math.max(5, t.value + Math.floor(Math.random() * 5) - 2),
        }))
      )
    }, 250)
