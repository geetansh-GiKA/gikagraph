    ...
    <div className="pointer-events-none select-none">
      <style>{`
        ...
        .gd-brand .gd-mark{
          ...
          background: linear-gradient(145deg, var(--accent), #ff5833);
          display:flex; align-items:center; justify-content:center;
          box-shadow: 0 0 0 1px #ff826633, 0 6px 16px -4px #ff826655; font-size:13px;
        }
        ...
        .gd-nav-item.active{ background: linear-gradient(90deg, #ff826614, transparent); color: var(--text-hi); }
        ...
        .gd-app-promo{
          ...
          border:1px solid #ff82662e; border-radius: var(--radius); padding:14px 14px;
        }
        ...
        .gd-search{
          ...
          background: var(--panel); border:1px solid var(--border); border-radius:11px; padding:9px 14px; color:var(--text-lo); font-size:12px;
        }
        ...
        .gd-icon-btn .gd-dot{ position:absolute; top:6px; right:6px; width:5px; height:5px; background:var(--accent); border-radius:50%; box-shadow:0 0 0 2px #0a0a0a; }
        .gd-profile{ display:flex; align-items:center; gap:9px; }
        .gd-avatar{
          width:32px;height:32px;border-radius:50%; background: linear-gradient(145deg, var(--accent), #cc2500);
        ...
        .gd-btn-primary{
          ...
          border:none; padding:9px 15px; border-radius:10px; box-shadow: 0 8px 20px -8px #ff826666;
        }
        ...
        .gd-stat-card{ background: var(--panel); border:1px solid var(--border); border-radius: var(--radius); padding:16px; }
        .gd-stat-card.hero{ background: radial-gradient(circle at 100% 0%, #ff826626, transparent 60%), var(--panel); border:1px solid #ff82663d; }
        ...
        .gd-stat-card.hero .gd-arrow{ border-color:#ff826655; color:var(--accent-soft); }
        ...
        .gd-stat-card.hero .gd-stat-foot{ background:#1f0f08; border-color:#ff826640; color:var(--accent-soft); }
        ...
        .gd-card{ background: var(--panel); border:1px solid var(--border); border-radius: var(--radius); padding:18px; }
        ...
        .gd-bar.filled{ background: var(--accent); border-color:#ff8266; }
        .gd-bar.filled.soft{ background: var(--accent-soft); border-color:#ffac99; }
        ...
        .gd-reminder-card{ background: linear-gradient(155deg, #1c0f08 0%, #141414 55%); border-color:#ff826630; }
        ...
        .gd-tracker-card{ background: radial-gradient(circle at 20% 0%, #ff82662e, transparent 55%), var(--panel); border-color:#ff826630; display:flex; flex-direction:column; justify-content:space-between; }
      ...
      <div className="grafino-dash">
        <div className="gd-app">
          <aside className="gd-sidebar">
            <div className="gd-brand">Grafino</div>
            ...
            <div className="gd-grid-mid">
              <div className="gd-card">
                <div className="gd-card-head">
                  ...
                  <span style={{ fontSize: "10.5px", color: "var(--text-lo)" }}>
                    This week
                  </span>
                </div>
              ...
              <div className="gd-card">
                ...
                <div className="gd-proj-list">
                  ...
                  <div className="gd-proj-item">
                    <div
                      className="gd-proj-ico"
                      style={{ background: "#241414", color: "var(--accent)" }}
                    >
                      ✦
                    </div>
                    <div>
